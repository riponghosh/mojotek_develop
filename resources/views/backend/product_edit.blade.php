...
@section('content')
	...
	<div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
        <div class="uk-width-large-10-10">
		    ...
		    @endif
            {{ Form::open(array('url' => 'admin/product/update/'.$data->id,'method' => 'POST', 'role' => 'form' , 'class' => 'uk-form-stacked', 'id' => 'user_edit_form','files' => true)) }}
                            ...
                            <div class="user_content">
                                <div class="uk-margin-top">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-1-2">
                                            <div class="parsley-row">
                                                <input type="text" id="name" name="name" value="{{$data->name}}" required class="md-input" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-1-2">
                                            <div class="parsley-row">
                                                <input type="text" id="price" name="price" value="{{$data->price}}" required class="md-input" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-1-2">
                                            <div class="parsley-row">
                                                <input type="text" id="brand" value="{{$data->brand}}" name="brand" required class="md-input" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-1-2">
                                            <div class="parsley-row">
                                                <input type="text" id="condition" value="{{$data->condition}}" name="condition" class="md-input" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-1-2">
                                            <div class="parsley-row">
                                                <input type="text" id="color" value="{{$data->color}}" name="color" required class="md-input" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="uk-grid" data-uk-grid-margin>
                                        ...
                                        <div class="uk-width-1-2">
                                            <div class="parsley-row">
                                                <textarea type="text" id="description" name="description" class="md-input">{{$data->description}}"</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                    <div>
                                        ...
                                        <?php $i=0; ?>
                                        @foreach($data->product_image as $image_show)
                                        <div class="uk-grid" data-uk-grid-margin>
                                            <div class="uk-width-1-5">
                                                <div class="parsley-row">
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                <div class="md-card">
                                                    <div class="md-card-content">
                                                        ...
                                                        <input type="file" id="input-file-a" name="image[<?php echo $i;$i++; ?>]" class="dropify" data-default-file="{{url('/uploads/images/product/'.$image_show->image)}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <center><a class="md-btn md-btn-danger md-btn-wave-light uk-float-right" onclick="deletedcurr({{$image_show->id}})" style="vertical-align: center"><center>Delete This Image</center></a></center>
                                        </div>
                                        @endforeach
...
<script type="text/javascript">
    $('#category_id').on('change',function(){
        ...
        else
        {
            ...
            var address = "/admin/product/edit/bycategory/"+'<?php echo $data->id; ?>/'+category_id;
        }
...
<script type="text/javascript">
    function deletedcurr(id){
            swal({
                ...
                window.location.href = "/admin/product/image/delete/"+id;
            })
    }
</script>
@endsection