        ...
        <div class="md-card-content">
            ...
            <div class="uk-modal" id="add_modal">
                <div class="uk-modal-dialog ">
                    ...
                    {{ Form::open(array('url' => 'admin/subcategory/store','method' => 'POST', 'role' => 'form' , 'class' => 'uk-form-stacked','files' => true)) }}

                    <div class="uk-overflow-container">
                        <div class="uk-width-1-2">
                            <label for="category_id" class="uk-form-label">Select Category</label>
                            <select id="category_id" name="category_id" class="single-select" required style="width: 100%;" >    
            ...
            <div class="uk-modal" id="edit_modal_{{$data_edit->id}}">
                <div class="uk-modal-dialog ">
                    ...
                    <div class="uk-overflow-container">
                    {{ Form::open(array('url' => 'admin/subcategory/update/'.$data_edit->id,'method' => 'POST', 'role' => 'form' , 'class' => 'uk-form-stacked','files' => true)) }}
                         <!-- <form id="add_topic_form" class="uk-form-stacked"> -->
                            <div class="uk-width-1-2">
                                <label for="category_id" class="uk-form-label">Select Category</label>
                                <select id="category_id" name="category_id" class="single-select" required style="width: 100%;" >    
                                    @foreach($all_category as $category)
                                        @if($category->id==$data_edit->id)
...
$('.delete_btn').click(function () {
    ...
    swal({
        ...
        window.location.href = "/admin/subcategory/delete/"+id;
    })
})
    </script>
