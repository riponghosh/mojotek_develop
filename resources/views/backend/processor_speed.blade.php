        ...
        <div class="md-card-content">
            ...
            <div class="uk-modal" id="add_modal">
                <div class="uk-modal-dialog ">
                    ...
                    {{ Form::open(array('url' => 'admin/processorspeed/store','method' => 'POST', 'role' => 'form' , 'class' => 'uk-form-stacked','files' => true)) }}
            ...
            <div class="uk-modal" id="edit_modal_{{$data_edit->id}}">
                <div class="uk-modal-dialog ">
                    ...
                    <div class="uk-overflow-container">
                    {{ Form::open(array('url' => 'admin/processorspeed/update/'.$data_edit->id,'method' => 'POST', 'role' => 'form' , 'class' => 'uk-form-stacked','files' => true)) }}
...
$('.delete_btn').click(function () {
    ...
    swal({
        ...
        window.location.href = "/admin/processorspeed/delete/"+id;
    })
})
    </script>
